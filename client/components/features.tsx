 ...
 */
 ...
 const Features = () => {
	 return (
		 <div className="flex">
				 <div className="transform transition duration-500 hover:scale-110 text-darkblue-default w-2/5 px-8 py-6 border-2 bg-white-default border-yellow-newYellow  shadow-2xl rounded-lg">
